...
export default class InteractiveMap extends Component {
  ...
  handleRemoveLocation = async (locationName) => {
    var data = {
      name: locationName,
    };
        ...
        >
          ...
          {this.state.selectedPremise ? (
            <Popup
              ...
              closeOnClick={false}
              onClose = {() => this.setState({selectedPremise:null})}
            >
              <div>
                ...
                {JSON.parse(sessionStorage.getItem("userData")).Status ===
                "admin" ? (
                  <button
                    className="boka-tid-knapp"
                    onClick={() =>
                      this.handleRemoveLocation(
                        this.state.selectedPremise.properties.NAME
                      )
                    }
                  >
                    Ta bort plats
          ...
          {this.state.newLocation != null ? (
            <Popup
              ...
              onClose = {()=>this.setState({newLocation:null})}
              closeOnClick={false}
            >
              <NewLocation
