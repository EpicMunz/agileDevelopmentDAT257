...
import {
  ...
  ViewsDirective, ViewDirective, TimelineViews,
...
export default class App extends React.Component {
        ...
        onPopupClose(args) {
             if (args.type === 'Editor' && !isNullOrUndefined(args.data)) {
                 let subjectElement = args.element.querySelector('#Summary');
                 if (subjectElement) {
                     (args.data).Subject = subjectElement.value +  " - " + sessionStorage.getItem("owner");
        ...
        editorTemplate(props) {
            ...
            <table className="custom-event-editor" style={{ width: '100%', cellpadding: '5' }}><tbody>
             ...
             <tr><td className="e-textlabel"></td><td colSpan={4}>
                <input id="Owner" className="e-field e-input" type="hidden" name="Subject" style={{ width: "100%" }}/>
              </td></tr>
       ...
       render() {
         ...
         return <ScheduleComponent ref={t => this.scheduleObj = t} width='100%' height='550px' currentView='Week'
         selectedDate={new Date(2017, 11, 15)} timeScale={{enable: true, interval: 60, slotCount: 1}}  editorTemplate={this.editorTemplate.bind(this)} showQuickInfo={false} popupOpen={this.onPopupOpen.bind(this)} popupClose={this.onPopupClose.bind(this)} eventRendered={this.onEventRendered.bind(this)} >
           <ViewsDirective>
